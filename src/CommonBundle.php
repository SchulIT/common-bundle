    ...
    public function configure(DefinitionConfigurator $definition): void {
        $definition->rootNode()
            ->children()
                ...
                ->arrayNode('disable')
                    ->children()
                        ->booleanNode('cron')->defaultFalse()->setDeprecated('schulit/common-bundle', '7.0')->end()
                        ->booleanNode('orm')->defaultFalse()->end()
                        ->booleanNode('messenger')->defaultFalse()->setDeprecated('schulit/common-bundle', '7.0')->end()
